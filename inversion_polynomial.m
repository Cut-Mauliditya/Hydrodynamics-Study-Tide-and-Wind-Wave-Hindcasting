...
ws_obs = xlsread('angin_bali', 'V2:V50'); 
wd_obs = xlsread('angin_bali', 'W2:W50');

fetch_l = xlsread('angin_bali', 'X2:X5'); 
fetch_d = xlsread('angin_bali', 'Y2:Y5');

Rt = 1.10 ;
v = Rt.*ws_obs ;
ws_obs_cor = 0.71*v.^1.23  ;
...
xlabel('t(hour)')
ylabel('H(m)')
legend({'inv order 6', 'inv order 8', 'inv order 10'})
